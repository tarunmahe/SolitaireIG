function CScore() {
    ...
    this.showScore = function(oPos, iPoint){
        ...
        var oScoreMoveBack = new createjs.Text("+"+iPoint,"24px "+PRIMARY_FONT, "#000000");
        ...
        var oScoreMove = new createjs.Text("+"+iPoint,"24px "+PRIMARY_FONT, "#fff");
        oScoreMove.x = oPos.x;
        oScoreMove.y = oPos.y;
        oScoreMove.scaleX=2;
        oScoreMove.scaleY=2;
    ...
    this.removeScore = function(iPoint, iTime){
        var oScoreNum = new createjs.Text(iPoint,"24px "+PRIMARY_FONT, "#ffffff");
        oScoreNum.x = 425;
        oScoreNum.y = 109;
        oScoreNum.alpha=0;
    ...
    this.displayMoves = function(iPoint, iTime){
        var oMoveNum = new createjs.Text(iPoint,"24px "+PRIMARY_FONT, "#ffffff");
        oMoveNum.x = 612;
        oMoveNum.y = 109;
        oMoveNum.alpha=0;
